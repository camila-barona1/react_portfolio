    ...
    <SkillsStyled>
      ...
      <InnerLayout>
        <div className="skills">
          ...
          <ProgressBar title={"PHP"} width={"60%"} text={"60%"} />
          <ProgressBar title={"React JS"} width={"75%"} text={"75%"} />
          <ProgressBar title={"NODEJS"} width={"75%"} text={"75%"} />
          <ProgressBar title={"SQL-DATABASE"} width={"75%"} text={"75%"} />
          <ProgressBar title={"CAKEPHP"} width={"60%"} text={"60%"} />
          <ProgressBar title={"ANGULAR"} width={"75%"} text={"75%"} />
        </div>
      </InnerLayout>
    </SkillsStyled>
  );
